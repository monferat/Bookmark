class Bookmarker < ApplicationRecord
  ...
  # has_attached_file :snapshot, styles: { medium: '300x300#' }, :storage => :s3, :s3_credentials => "#{Rails.root}/config/aws.yml"
  # validates_attachment_content_type :snapshot, content_type: /\Aimage\/.*\z/

  has_attached_file :snapshot, styles: { medium: '300x300#', thumb: '200x200#' }, default_url: '/images/missing.png'
